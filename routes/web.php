...
Route::post('/sendSMS/', [OtpMailSMSController::class, 'verify_mobile']);
...
Route::post('/validateSMSOTP/', [OtpMailSMSController::class, 'validateSMSOTP']);
...
Route::prefix('panel')->middleware(['verified'])->group(function () {
    ...
    Route::resource('admin_student_doc', AdminStudentDocsController::class);
