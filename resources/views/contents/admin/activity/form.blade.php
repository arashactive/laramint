...
<div class="col-12">
    <div class="card shadow mb-4 border-bottom-primary">
        ...
        <div
            ...
            <h6 class="m-0 font-weight-bold text-primary">{{ __("Activities") }}</h6>
        ...
        <div class="card-body">
            <div class="text-center">
                ...
                @if(isset($activity))
                    <form class="user" method="POST" action="{{ route('activity.update' , $activity->id) }}">                    
                     @method('patch')
                @else
                    <form class="user" method="POST" action="{{ route('activity.store') }}">
                @endif
